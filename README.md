...
This is a sample template for ellen-debug - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name ellen-debug --tail
```
...
```bash
aws cloudformation delete-stack --stack-name ellen-debug
```
